...
class TestCreateSurvey:
    ...
    def test_create_survey(self):
        valid_username= self.config.get('users_data', 'valid_username')
        valid_password = self.config.get('users_data', 'valid_password')
    ...
    def test_edit_survey_category(self):
        self.log_p.user_login(valid_username, valid_password)
        self.c_survey_p.create_survey(survey_title, survey_category)
        self.c_survey_design.edit_survey_category(new_survey_category)
